...
class Classroom1 extends StatelessWidget {
  const Classroom1({super.key});
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage(
                            dummyClassrooms[0].classroomBackGroundImage),
                        fit: BoxFit.cover),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      dummyClassrooms[0].courseName,
                      style: Theme.of(context)
                          .textTheme
                          .titleLarge!
                          .copyWith(color: Colors.white),
                    ),
                    Text(dummyClassrooms[0].section,
                        style: Theme.of(context)
                            .textTheme
                            .titleMedium!
                            .copyWith(color: Colors.white))
