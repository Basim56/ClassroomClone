...
class Classroom2 extends StatelessWidget {
  const Classroom2({super.key});
  @override
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage(
                            dummyClassrooms[1].classroomBackGroundImage),
                        fit: BoxFit.cover),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      dummyClassrooms[1].courseName,
                      style: Theme.of(context).textTheme.titleLarge!.copyWith(
                          color: Colors.white, overflow: TextOverflow.ellipsis),
                    ),
                    Text(dummyClassrooms[1].section,
                        style: Theme.of(context)
                            .textTheme
                            .titleMedium!
                            .copyWith(color: Colors.white))
