...
class Classroom4 extends StatelessWidget {
  const Classroom4({super.key});
  @override
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage(
                            dummyClassrooms[3].classroomBackGroundImage),
                        fit: BoxFit.cover),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      dummyClassrooms[3].courseName,
                      style: Theme.of(context)
                          .textTheme
                          .titleLarge!
                          .copyWith(color: Colors.white),
                    ),
                    Text(dummyClassrooms[3].section,
                        style: Theme.of(context)
                            .textTheme
                            .titleMedium!
                            .copyWith(color: Colors.white))
