...
class Classroom3 extends StatelessWidget {
  const Classroom3({super.key});
  @override
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage(
                            dummyClassrooms[2].classroomBackGroundImage),
                        fit: BoxFit.cover),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      dummyClassrooms[2].courseName,
                      style: Theme.of(context)
                          .textTheme
                          .titleLarge!
                          .copyWith(color: Colors.white),
                    ),
                    Text(dummyClassrooms[2].section,
                        style: Theme.of(context)
                            .textTheme
                            .titleMedium!
                            .copyWith(color: Colors.white))
